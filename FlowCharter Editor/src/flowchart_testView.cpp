...
void Cflowchart_testView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	Cflowchart_testDoc* pDoc = GetDocument();
	pDoc->m_point2=point;
...
void Cflowchart_testView::SetRectangle()
{
	Cflowchart_testDoc* pDoc = GetDocument();
...
void Cflowchart_testView::OnEditCut() 
{
...
void Cflowchart_testView::OnEditCopy() 
{
	// TODO: Add your command handler code here
	Cflowchart_testDoc* pDoc = GetDocument();
		InvalidateRect(NULL,FALSE);
